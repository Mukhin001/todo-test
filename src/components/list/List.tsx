        ...
        <>
            <ul>
                { arrToDo.filter((todo) => filterArrToDo(todo, keyShowToDO)).map(toDo => 
                    <li className={st.listLi} key={toDo.id}>
                        <div data-id={toDo.id} className={`${st.listLi__content} ${toDo.done ? st.doneTodo : ''}`} onClick={handleChooseToDo}>
                        ...
                        <div className={st.listLi__iconEdit}>
